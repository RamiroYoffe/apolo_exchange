...
router.get('/:value', systemsControllers.system_get_one)
router.get('/currency/:currency', systemsControllers.system_get_currency)
router.get('/id/:id', systemsControllers.system_get_id)
router.delete('/:value', systemsControllers.system_delete_value)
router.patch('/:value', systemsControllers.system_modify_value)
